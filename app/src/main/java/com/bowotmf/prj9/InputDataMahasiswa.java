...
public class InputDataMahasiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInputData = (Button) findViewById(R.id.btnInputDataMhs);
    ...
    private void inputDataMahasiswa(final String nama,final String npm,final String alamat) {
